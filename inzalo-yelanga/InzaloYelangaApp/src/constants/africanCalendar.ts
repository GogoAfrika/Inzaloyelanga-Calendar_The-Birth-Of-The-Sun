import { AfricanMonth } from '../types';

export const AFRICAN_NEW_YEAR_MONTH = 8; // September (0-indexed)
export const AFRICAN_NEW_YEAR_DAY = 23;
...
export const MONTHS_DATA: AfricanMonth[] = [
  {
    ...
    color: "#E6B0AA",
    imageUrl: "https://via.placeholder.com/150x150/E6B0AA/000000?text=Asar",
  ...
  },
  {
    ...
    color: "#D7BDE2",
    imageUrl: "https://via.placeholder.com/150x150/D7BDE2/000000?text=Geb",
  ...
  },
  {
    ...
    color: "#A9CCE3",
    imageUrl: "https://via.placeholder.com/150x150/A9CCE3/000000?text=Het-Hor",
  ...
  },
  {
    ...
    color: "#FAD7A0",
    imageUrl: "https://via.placeholder.com/150x150/FAD7A0/000000?text=Ra",
  ...
  },
  {
    ...
    color: "#85C1E9",
    imageUrl: "https://via.placeholder.com/150x150/85C1E9/000000?text=Sobek",
  ...
  },
  {
    ...
    color: "#AED6F1",
    imageUrl: "https://via.placeholder.com/150x150/AED6F1/000000?text=Shu",
  ...
  },
  {
    ...
    color: "#F5CBA7",
    imageUrl: "https://via.placeholder.com/150x150/F5CBA7/000000?text=Isis",
  ...
  },
  {
    ...
    color: "#ABB2B9",
    imageUrl: "https://via.placeholder.com/150x150/ABB2B9/000000?text=Neb-Het",
  ...
  },
  {
    ...
    color: "#566573",
    imageUrl: "https://via.placeholder.com/150x150/566573/FFFFFF?text=Set",
  ...
  },
  {
    ...
    color: "#D6EAF8",
    imageUrl: "https://via.placeholder.com/150x150/D6EAF8/000000?text=Djehuti",
  ...
  },
  {
    ...
    color: "#F9E79F",
    imageUrl: "https://via.placeholder.com/150x150/F9E79F/000000?text=Horus",
  ...
  },
  {
    ...
    color: "#F0B27A",
    imageUrl: "https://via.placeholder.com/150x150/F0B27A/000000?text=Neith",
  ...
  },
  {
    ...
    color: "#A3E4D7",
    imageUrl: "https://via.placeholder.com/150x150/A3E4D7/000000?text=Sokhemet",
...
export const calculateAfricanDate = () => {
  ...
  let dayOfYear = Math.floor((today.getTime() - startOfYear.getTime()) / millisecondsPerDay);
